var value_to_display = 'Chronic Respiratory Diseases'

var initial_data;

var allGroup = ['Chronic Respiratory Diseases', 'Total Cancer', 'Air Cancer', 'Pneumoconiosis', 'Asthma', 'Interstitial Lung Disease and Pulmonary Sarcoidosis', 'Other Chronic Respiratory Diseases', 'Total Sum Of Disease']
...
d3.select("#selectButton").attr("value", 'Chronic Respiratory Diseases')
...
function line_cahrt_dth_loader(data){
    ...
    svg.selectAll(".line")
        ...
        .append("path")
            ...
            .attr("d", function(d){
                                    return d3.line()
                                                    .x(function(d) { return x(d.Year)+((x("2003")-x("2002"))/2); })                                                    .y(function(d) { return y(+d[value_to_display]); })
                                                    (d.values)
                                    })
